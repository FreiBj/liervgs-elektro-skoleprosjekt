...
const quiz = {
  ...
  questions: [
    ...
    {
      question:
        "Hvordan kan du justere pulssignalene i en DC til AC til den spenningen du vil ha dem????????",
      questionType: "text",
      answerSelectionType: "single",
      answers: [
        "Den gjør det automatisk",
        "Med en transformator  ",
        "En bryter",
        "Med å invertere pulssignalet ",
      ],
      correctAnswer: "2",
        ...
        <section className="intro">
          <div className="container">
            <div className="text-wrapper">
              ...
              <p>
                Når man skal gjøre om DC spenning, fra for eksempel solcelle
                panel eller batteri, til AC spenning så bruker man
                DC/AC-omformere. Prosessen fra DC til AC i DC/AC-omformere er at
                den først hakker opp DC spenningen og blir pulssignaler ved
                hjelp av elektronikk. Deretter kan pulssignalet bli transformert
                til høyere eller lavere spenningen ved hjelp av en
                transformator. Kvaliteten på pulssignalet er veldig forskjellig
                på kvaliteten på filteret man bruker. Man kan få alt fra
                firkantpulserende AC-spenning til støyfrie og gode sinuskurver.
              </p>
            </div>
          </div>
        </section>
              ...
              <div className="row">
                <div className="col">
                  <div className="text-block">
                    ...
                    <p>
                      {" "}
                      Dette er for å gjøre at spenningen inn i transformatoren
                      ikke har noen direkte kontakt mellom spenningen inn og ut,
                      dette høres fortsatt ikke veldig effektivt, men dette
                      oppnår at kretsen ikke har en sluttet krets mellom person
                      og jord hvis de kommer i kontakt med kabelen som
                      illustrert i bildet over. <br />
                      <br />
                      AC-spenningen man får etterpå kan man bruke til for
                      eksempel et kjøleskap på hytta eller noe annet som trenger
                      spenning
                    </p>
                  </div>
                </div>
              ...
              <div className="column right">
                <project-card>
                  <Link to="/actildc/">
                    ...
                    >
                      <div className="text">
                        <p className="ng-star-inserted">— AC til DC.</p>
                        {/**/}
                      </div>
                      {/**/}
                    </a>
