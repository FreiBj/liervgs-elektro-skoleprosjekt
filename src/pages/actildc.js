...
import roadmap from "../images/kurs2/roadmap.png"
import curvy from "../images/kurs2/curvy.png"
import dcurb from "../images/kurs2/doublecurve.png"
import first from "../images/kurs2/first.png"
import matti from "../images/ezgif.com-gif-maker.gif"
import r1 from "../images/kurs2/r1.png"

const quiz = {
  quizTitle: "<AC til DC QUIZ!!!<3>",
  quizSynopsis:
    "Bevis at du har lært noe her, eller ikke. Det er helt innafor, men prøv da å reflektere over det du har lest om ;)",
  nrOfQuestions: "2",
  questions: [
    {
      question: "Hva brukes som et filter i en AC-DC frekvensomformer? ?",
      questionType: "text",
      questionPic: "https://dummyimage.com/600x400/000/fff&text=X", // if you need to display Picture in Question
      answerSelectionType: "single",
      answers: [
        "Et reaksjonsfilter",
        "Det går ikke å filtrere typen AC-DC omformer. ",
        "En rotasjonsgiver ",
        "En kondensator",
      ],
      correctAnswer: "4",
    ...
    {
      question:
        "Hvor stor blir rippelfrekvensen i en toveis likeretter hvis vekselspenningen er 50Hz? ",
      questionType: "text",
      answerSelectionType: "single",
      answers: ["25Hz", "50Hz", "100Hz", "0Hz"],
      correctAnswer: "3",
        ...
        <section className="intro">
          <div className="container">
            <div className="text-wrapper">
              ...
              <p>
                Et bilde av før og etter at spenningen har gått gjennom dioden.
                Som man ser øverst så omformer dioden vekselspenningen som er
                både negativ og positivt ladet om til bare å være positivt
                ladet. Deretter så kommer filter stadiet av prosessen. Dette
                skjer gjennom at en kondensator lager en rippelspenning for å
                jevne ut distansen mellom hver av toppene på spenningen.
                (Illustrert under)
              </p>
            </div>
            <div className="image-grid">
                ...
                <div className="col">
                  <div className="text-block">
                    ...
                    <p>
                      ...
                      <br />
                      <br />
                      Lignende konsept som enveislikeretter bare at kretsen tar
                      vare på både den positive ladet spenningen og den negative
                      ladet, men den separerer dem. Positive ladet spenning:
                      <br /> <br />
                      <ul className="styled-list">
                        <li>Lignende konsept</li>
                        <ul class="styled-list nested">
                          <li>
                            Lignende konsept som enveislikeretter bare at
                            kretsen tar vare på både den positive ladet
                            spenningen og den negative ladet, men den separerer
                            dem.
                          </li>
                          <li>Positive ladet spenning:</li>
                          <li>
                            <img src={first} alt="" />
                          </li>
                        </ul>

                        <li>Negativt ladet spenning</li>
                      ...
                      <br />
                      <br />
                      Til slutt kommer kondensatoren og jevner ut spenningen,
                      den jevner ut begge spenningene som fører til at
                      rippelfrekvensen blir dobbelt så stor som vekselspenningen
                      med toveis likeretter.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <project-card>
                  <Link to="/dctildc/">
                    ...
                    >
                      ...
                      <div className="text">
                        <p className="ng-star-inserted">— DC til DC.</p>
                        {/**/}
                      </div>
                      {/**/}
                    </a>
